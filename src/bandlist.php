<?php
/*
ADDRESS:	HTTP://ALBERTYW.MIT.EDU/6470/BANDLIST.PHP
STATUS:		FINISHED
...
$title='molemusic | List Bands';
$googlemaps=false;
$freebase=false;
session_start();
include("/opt/lampp/htdocs/6470/include/headeropen.php");
echo '<script type="text/javascript" src="http://albertyw.mit.edu/6470/include/bandlist.js"></script>';
include("/opt/lampp/htdocs/6470/include/headertext.php");?>

<center><h1>List All Bands</h1></center><br />

<div id="viewbands"></div>
